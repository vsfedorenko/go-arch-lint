...
import (
	"github.com/vsfedorenko/go-arch-lint/internal/pkg/deepscan/test/project/internal/operations"
	"github.com/vsfedorenko/go-arch-lint/internal/pkg/deepscan/test/project/internal/repository"
)
