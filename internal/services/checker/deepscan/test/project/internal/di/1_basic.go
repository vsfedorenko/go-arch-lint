...
import (
	"github.com/vsfedorenko/go-arch-lint/v3/internal/services/checker/deepscan/test/project/internal/operations"
	"github.com/vsfedorenko/go-arch-lint/v3/internal/services/checker/deepscan/test/project/internal/repository"
)
